...
export const StudentDashboard = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] w-full py-8 px-4 sm:px-6 bg-gradient-to-b from-[#0B1220] via-[#0F172A] to-[#111827] text-slate-100 overflow-hidden box-border">
      {/* Subtle Ambient Radial Glow Layers */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[380px] bg-gradient-to-b from-blue-600/15 via-cyan-500/8 to-transparent rounded-full blur-3xl pointer-events-none -z-0" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(30,58,138,0.2),rgba(15,23,42,0))] pointer-events-none -z-0" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-8 animate-fade-in">
        ...
        <div className="text-center space-y-2.5 pb-2">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-blue-950/80 border border-blue-700/60 text-cyan-300 text-xs font-bold uppercase tracking-wider shadow-sm">
        ...
        {!activeReportingCategory && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-mono font-semibold text-cyan-400">Automatic Department Routing</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {STUDENT_ISSUE_CARDS.map((card) => {
                ...
                return (
                  <div
                    key={card.category}
                    className={`p-5 sm:p-6 rounded-3xl bg-[#131E36] hover:bg-[#16233F] border ${card.border} shadow-xl shadow-slate-950/30 transition-all flex flex-col justify-between space-y-5 group`}
                  >
                    <div className="space-y-3.5">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-mono font-bold px-2.5 py-1 rounded-lg bg-[#192744] text-slate-200 border border-[#2B3F68]">
                    ...
                    <button
                      ...
                      className={`w-full py-2.5 px-4 rounded-xl bg-gradient-to-r ${card.color} hover:brightness-110 text-white font-bold text-xs flex items-center justify-center space-x-2 shadow-lg shadow-slate-950/40 transition-all active:scale-95 border border-white/20`}
                    >
        ...
        {!activeReportingCategory && (
          <div className="p-6 rounded-3xl bg-[#131E36] border border-[#22355A] shadow-2xl shadow-slate-950/30 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-[#22355A]">
              ...
              <div className="space-y-2.5">
                {studentReports.map((report) => (
                  <div
                    ...
                    className="p-3.5 rounded-2xl bg-[#192744] border border-[#273B60] hover:border-cyan-500/50 hover:bg-[#1E2E50] cursor-pointer flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 group transition-all"
                  >
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-[11px] font-mono font-semibold text-cyan-400">{report.id}</span>
                      </div>
